    ...
    public function createSignTransaction(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'attachment_sign'=> 'required|mimes:png,jpg,pdf,jpeg',
            ], [
            ...
            $slug_name = Str::slug($request->title.' attachment', '-');
            $sign_attachment_name = $slug_name.'.'.$sign_attachment->getClientOriginalExtension();
            $sign_attachment->move(public_path('attachment/sign'), $sign_attachment_name);
