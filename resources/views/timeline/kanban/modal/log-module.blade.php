<div class="modal fade" id="logModuleModal">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body my-0 mx-0">
                <table class="datatable-stepper" id="log_module_table">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center;" class="sort" data-sort="title">Title</th>
