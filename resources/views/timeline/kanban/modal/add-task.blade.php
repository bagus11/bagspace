        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-2 mt-2 plan_container">
                        <p>Plan</p>
                    </div>
                    <div class="col-4 plan_container" >
                        <input type="text" class="form-control" id="plan_sub_module">
                        <span style="color:red;" class="message_error text-red block plan_sub_module_error"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2 mt-2">
