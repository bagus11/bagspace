    ...
    // Operation
        ...
        $('#booking_table').on('click', '.detail', function(){
            ...
            getCallback('detailTicket',data,function(response){
                ...
                $('#meeting_link_label').html(': <a target="_blank" href="meetingRoom/'+response.detail.meeting_link+'" class="ml-3" style="color:blue;"> Click here</a>')
                // $('#meeting_link_label').html(response.detail.meeting_code == 2 ?': -': ': <a target="_blank" href="meetingRoom/'+response.detail.meeting_link+'" class="ml-3" style="color:blue;"> Click here</a>')
